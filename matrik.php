      ...
      <div class="page-content">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <div class="card-body pt-0">
                  <p class="card-text" style="text-align: justify;">Melakukan perhitungan normalisasi untuk mendapatkan matriks nilai ternormalisasi (R), dengan ketentuan :
                ...
                <button type="button" class="btn btn-primary btn-sm ms-4" data-bs-toggle="modal" data-bs-target="#inlineForm">
        ...
        ORDER BY a.id_alternative";
            ...
            <a href='keputusan-hapus.php?id={$row->id_alternative}' class='btn btn-danger btn-sm'>Hapus</a>
                  ...
                  <table class="table table-dark table-striped mb-4 mt-4">
                    <caption style="caption-side: top;font-weight: bold;">
